...
const { createPostCtrl, getAllPostsCtrl, getPostCtrl, getPostCountCtrl, deletePostCtrl,updatePostCtrl, updatePostImageCtrl} = require('../Controllers/postController');
